    ...
    function ChatBox() {
        ...
        const { roomId: contextRoomId, newMessage, chatHistory,markAsRead} = echo;
                            ...
                            {messages.map((message, index) => (
                                <li
                                    ...
                                    style={{
                                        ...
                                        margin: '5px 0',
                                        padding: '10px',
                                        backgroundColor: message.read === true ? 'rgb(80, 140, 208)' : '#f1f1f1',
                                        borderRadius: '10px',
                                        maxWidth: '47%',
                                        whiteSpace: "pre-wrap",
                                        marginLeft: message.sender === sender._id ? 'auto' : '0',  
                                        marginRight: message.sender === sender._id ? '0' : 'auto'  
                                    }}
                                    >
                                    {message.message}
                                </li>
